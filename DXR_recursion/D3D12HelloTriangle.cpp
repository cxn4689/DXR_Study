...
void D3D12HelloTriangle::CreatePlaneVB_light() {
	// Define the geometry for a plane.
	Vertex planeVertices[] = {
		{{-1.4f, 0.7f, 01.4f}, {1.0f, 1.0f, 1.0f, 1.0f}}, // 0
		{{-1.3f, 0.7f, 01.4f}, {1.0f, 1.0f, 1.0f, 1.0f}}, // 1
		{{-1.3f, 0.7f, 01.3f}, {1.0f, 1.0f, 1.0f, 1.0f}}, // 2
		{{-1.3f, 0.7f, 01.3f}, {1.0f, 1.0f, 1.0f, 1.0f}}, // 2
		{{-1.4f, 0.7f, 01.3f}, {1.0f, 1.0f, 1.0f, 1.0f}}, // 1
		{{-1.4f, 0.7f, 01.4f}, {1.0f, 1.0f, 1.0f, 1.0f}}, // 4
...
void D3D12HelloTriangle::CreateAccelerationStructures() {
  ...
  AccelerationStructureBuffers LightplaneBottomLevelBuffers =
	  CreateBottomLevelAS({ {m_planeBuffer_light.Get(), 6 * 1} });//area light
...
void D3D12HelloTriangle::CreateRaytracingPipeline() {
  ...
  m_hitSignature3 = CreateHitSignature(304);
  //
  ...
  pipeline.SetMaxPayloadSize(4 * sizeof(float) * 2); // RGB + distance
  ...
  pipeline.SetMaxRecursionDepth(2);//FIXME
